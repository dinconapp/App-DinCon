-- DinCon - PostgreSQL schema for Neon import
-- Import this file in Neon SQL Editor or run with psql against the Neon database.
-- It creates the application tables and inserts default categories.
