...
export function LoggedSubscriptionContent() {
  ...
  return (
    <section className="cf-billing-wrap">
      <div className="cf-card-head">
        ...
        <Link href="/planos" className="cf-btn primary">Ver planos</Link>
      </div>
        ...
        <div className="cf-grid cf-two">
            ...
            <div className="cf-grid">
              ...
              <div className="cf-pix-actions">
                {!billing.has_active_subscription ? (
                  <Link href="/planos" className="cf-btn primary">Ativar WhatsApp</Link>
                ) : (
                  <Link href="/planos" className="cf-btn primary">Renovar antecipadamente</Link>
                )}
              </div>
            </div>
          </Card>
          <Card title="WhatsApps autorizados">
            <div className="cf-grid">
              ...
              <Link href="/perfil" className="cf-btn">Gerenciar WhatsApps</Link>
            </div>
          </Card>
