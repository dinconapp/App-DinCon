...
export function ProfilePageClean({ userId, onInitial, onDone }: { userId: string; onInitial: (initial: string) => void; onDone: (message: string, tone?: "success" | "error") => void }) {
  ...
  return (
    <div className="cf-grid">
      ...
      <div className="cf-grid cf-two">
        {canUseWhatsApp ? (
          <WhatsAppAuthorizedAccountsCard userId={userId} onDone={onDone} canManage />
        ) : (
